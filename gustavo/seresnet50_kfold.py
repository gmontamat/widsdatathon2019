...
from .se_resnet50 import SEResNet50, preprocess_input
...
def resnet50():
    model = SEResNet50(weights=None, input_shape=(height, width, 3), classes=1)
...
for index_90, index_70, index_50 in zip(
    ...
    model.fit(
        images, responses, batch_size=16, epochs=10,
    ...
    model.save('seresnet50_kfold{}.h5'.format(k))
...
for i in range(1, kfold + 1):
    model_name = 'seresnet50_kfold{}.h5'.format(i)
